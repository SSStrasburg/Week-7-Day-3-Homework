 ...
 */
  ...
  vm.newItem = {}; // empty field default, we want to end with an empty field after submission also
  vm.sortType = 'price'; //default sort type
  vm.sortReverse = false; // default sort order is be regular order
  vm.inventory = InventoryService.getAllItems();  // empty field default, we want to end with an empty field after submission also
